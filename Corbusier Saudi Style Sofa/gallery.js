document.addEventListener('DOMContentLoaded', function() {
    ...
    const images = [
        'WhatsApp Image 2026-04-12 at 12.55.39.jpeg',
    ];
    ...
    const imagePromises = images.map(filename => {
        return new Promise(resolve => {
            ...
            img.alt = 'Corbusier Saudi Style Sofa';
    ...
    function openLightbox(index) {
        ...
        lightbox.innerHTML = `
            <div class="lightbox-content">
                <img src="./gallery/${encodeURIComponent(images[index])}" class="lightbox-img" alt="Corbusier Saudi Style Sofa">
    ...
    function navigateLightbox(direction) {
        ...
        if (img) img.src = `./gallery/${encodeURIComponent(images[currentIndex])}`;
    }
